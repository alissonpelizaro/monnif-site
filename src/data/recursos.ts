...
export interface Recurso {
  ...
  icone: string;
  /**
   * O ícone é sólido, e não de traço como os outros. Só o WhatsApp usa: é a
   * marca de outra empresa, e desenhá-la em traço a descaracteriza.
   */
  iconeSolido?: boolean;
