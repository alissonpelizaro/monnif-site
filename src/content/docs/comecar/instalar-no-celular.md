...
A barra lateral do desktop vira uma **barra inferior** com Dashboard, Despesas, Receitas e Cartões. O resto do menu fica em **Mais**. O botão do assistente continua flutuando no canto, em qualquer tela.
